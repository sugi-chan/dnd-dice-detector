...
out = cv2.VideoWriter('roll_output.mp4',fourcc, 30.0, (640,480))
...
while(video.isOpened()):
    ...
    frame, class_list = vis_util.visualize_boxes_and_labels_on_image_array(
        frame,
        np.squeeze(boxes),
    ...
    cv2.putText(frame,'Dice value: '+str(class_sum), 
    CornerOfText, 
    font, 
    fontScale,
    fontColor,
